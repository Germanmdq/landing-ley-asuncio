    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-6 md:px-10 pointer-events-none">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          {/* Título principal estilo Lusion */}
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-medium text-black tracking-tight leading-tight">
            Un lugar para sostener el estado con práctica real
          </h1>

          {/* Subtítulo */}
          <p className="text-lg md:text-xl text-black/60 max-w-3xl mx-auto">
            Biblioteca, Tutor IA, y Comunidad para expandir tu mente
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8 pointer-events-auto">
            <Link
              href="/#planes"
              className="group px-8 py-4 bg-black text-white font-medium rounded-full hover:scale-105 transition-all flex items-center justify-center gap-3"
            >
              Explorar Planes
            ...
            <Link
              href="/blog"
              className="px-8 py-4 bg-white text-black font-medium rounded-full border-2 border-black hover:bg-black hover:text-white transition-all"
            >
              Ver Biblioteca
            </Link>
          </div>
